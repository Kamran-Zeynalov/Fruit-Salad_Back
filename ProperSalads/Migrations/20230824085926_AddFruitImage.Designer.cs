...
namespace ProperSalads.Migrations
{
    ...
    [Migration("20230824085926_AddFruitImage")]
    partial class AddFruitImage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProperSalads.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProperSalads.Models.FruitCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProperSalads.Models.FruitCategory", b =>
                {
                    b.HasOne("ProperSalads.Models.Category", "GetCategory")
                        .WithMany("fruitCategories")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProperSalads.Models.Fruit", "GetFruit")
                        .WithMany("fruitCategories")
